        ...
        <frame name='case-top' src='./casingborder.html' noresize scrolling='no'>										<!-- Casing: border top -->
            <frameset cols='3%,31%,*,31%,3%' border='10'>																
                ...
                <frameset rows='50%,50%' border='10'>
                    ...
                    <frame name='center-left-bottom' src='./1/puzzel 3/puzzel3.html' noresize scrolling='no'>				<!-- Casing: lower left corner / puzzle game 1 -->
                </frameset>
                <frameset rows='50%,50%' border='10'>
                    <frame name='center-middle-top' src='./2/puzzel_3/puzzel_2_a3.html' noresize scrolling='no'>					<!-- Casing: center top / puzzle game 2 -->
                ...
                <frameset rows='50%,50%' border='10'>
                    ...
                    <frame name='center-right-bottom' src='./2/puzzel_4/puzzel_2_a4.html' noresize scrolling='no'>				<!-- Casing: lower right corner / puzzle frame 5 -->
                </frameset>
