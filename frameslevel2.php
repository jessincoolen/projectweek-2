        ...
        <frame name='case-top' src='./casingborder.html' noresize scrolling='no'>										<!-- Casing: border top -->
            <frameset cols='3%,31%,*,31%,3%' border='10'>																
                ...
                <frameset rows='50%,50%' border='10'>
                    ...
                    <frame name='center-left-bottom' src='./1/puzzel 2/puzzel2.html' noresize scrolling='no'>				<!-- Casing: lower left corner / puzzle game 1 -->
                </frameset>
                <frameset rows='50%,50%' border='10'>
                    <frame name='center-middle-top' src='./2/puzzel_2/puzzel_2.html' noresize scrolling='no'>					<!-- Casing: center top / puzzle game 2 -->
                    <frame name='center-middle-bottom' src='https://jdkos.nl/www/php/index.php' noresize scrolling='no'>				<!-- Casing: center bottom / puzzle frame 3 -->
                </frameset>
                <frameset rows='50%,50%' border='10'>
                    <frame name='center-right-top' src='http://ivoheuts.nl/pdf/Heuts_Ivo_cv.pdf' noresize scrolling='no'>					<!-- Casing: upper right corner / puzzle frame 4 -->
                    <frame name='center-right-bottom' src='https://photo.isu.pub/dieterbollen/photo_large.jpg' noresize scrolling='no'>				<!-- Casing: lower right corner / puzzle frame 5 -->
                </frameset>
