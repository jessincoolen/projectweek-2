        ...
        <frame name='case-top' src='./casingborder.html' noresize scrolling='no'>										<!-- Casing: border top -->
            <frameset cols='3%,31%,*,31%,3%' border='10'>																
                ...
                <frameset rows='50%,50%' border='10'>
                    ...
                    <frame name='center-middle-bottom' src='puzzel_2/puzzel_2_a2_completed.html' noresize scrolling='no'>				<!-- Casing: center bottom / puzzle frame 3 -->
                </frameset>
                <frameset rows='50%,50%' border='10'>
                    <frame name='center-right-top' src='puzzel_3/puzzel_2_a3.html' noresize scrolling='no'>					<!-- Casing: upper right corner / puzzle frame 4 -->
                    <frame name='center-right-bottom' src='puzzel_4/puzzel_2_a4_completed.html' noresize scrolling='no'>				<!-- Casing: lower right corner / puzzle frame 5 -->
                </frameset>
